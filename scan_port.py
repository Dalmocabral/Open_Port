...
((_)  __((_)  _ ((_)   (_))    )\___   )\ _ )\   _((_)   |___|   (_))     ((_)  (_))   (_(_()) 
| __| \ \/ / | | | |   / __|  ((/ __|  (_)_\(_) | \| |           | _ \   / _ \  | _ \  |_   _| 
| _|   >  <  | |_| |   \__ \   | (__    / _ \   | .` |           |  _/  | (_) | |   /    | |   
|___| /_/\_\  \___/    |___/    \___|  /_/ \_\  |_|\_|           |_|     \___/  |_|_\    |_|  \033[0;0m 
                                                                                             
           \033[33m             +------------------------------------------------+
                        | Desenvolvedor : Dalmo S. Cabral (Exumirim)     |
                        | Data de Criação: 29/12/2016                    |
                        | Facebook: https://www.facebook.com/exu.mirim.3 |
                        |                                                |
                        | Fanpage no Face: Fsociety Brasil - Iniciante   |
                        | Site: https://fsocietybrasil.tk                |
                        +------------------------------------------------+ \033[0;0m


Deseja fazer qual Scanner:

[1] Scanner das principais portas.
[2] Scanner Manual.
[3] Lista de portas de protocolos
								
								""")


menu = int(input("Qual Scanner deseja: "))


if menu == 1:

	ip = str(input("Entre com \033[34mIP\033[0;0m ou endereço do \033[34msite \033[0;0m que deseja scannear: "))
	ports = [20, 21, 22, 23, 25, 43, 53, 80, 110, 143, 443, 523, 993, 1433, 1521, 1723, 3306, 3389, 5432, 5900]
	#service = ["ftp-data", "ftp", "ssh", "telnet", "smtp", "nicname", "domain", "http", "pop3", "imap", "https", "ibm-db2", "imaps", "ms-sql-s", "oraclesrv", "pptp", "mysql", "ms-wbt-server", "postgresq", "vnc-server"]
	...
	for port in ports:
		...
		if conexao == 0:
			print ("\n %d \033[32m >>> Porta aberta \033[0;0m" % port)

		else:
			print ("\n %d \033[31m >>> Porta Fechada \033[0;0m" % port)

elif menu == 2:
	ip = str(input("\nEntre com IP ou endereço do site que deseja scannear: "))
	ports = []
	x = int(input("\nDigite a quantidade de portas que deseja scannear: "))
	...
	print ('''
								  ...
								  \033[31m  Lista de portas de protocolos \033[0;0m
